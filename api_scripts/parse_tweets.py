...
with open(sys.argv[1]) as json_file:
	print("tweet_id,tweet_created_at,tweet_test,tweet_hashtages,tweet_urls,user_id,user_name,user_location,num_followers,num_following,user_creation_date,user_verified,tweet_location,tweet_coordinates")
